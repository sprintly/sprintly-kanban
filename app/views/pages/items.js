    ...
    return (
      <div className="container-tray">
        <header className="product__header container-fluid">
          <svg className="running-man" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" width="20px" height="22px" viewBox="0 0 20 22" enable-background="new 0 0 20 22">
